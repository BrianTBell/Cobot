...
static const _Observation_type_support_symbol_names_t _Observation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cobot_interfaces, msg, Observation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cobot_interfaces, msg, Observation)),
  }
};
...
{
  return &::cobot_interfaces::msg::rosidl_typesupport_cpp::Observation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cobot_interfaces, msg, Observation)() {
  return get_message_type_support_handle<cobot_interfaces::msg::Observation>();
}
